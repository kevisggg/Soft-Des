...
public class SpaceInvaders extends JPanel implements ActionListener, KeyListener, MouseListener {
    ...
    // Resource paths
    public static final String FONT_PATH = "/res/SI/fonts/space_invaders.ttf";
    public static final String IMAGE_PATH = "/res/SI/images/";
    public static final String SOUND_PATH = "/res/SI/sound/";
