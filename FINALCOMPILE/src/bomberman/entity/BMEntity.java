...
public class BMEntity implements EntityInterface {
	...
	public BMEntity(BMGamePanel gp, BMCollisionChecker colCheck) {
		this.gp = gp;
	...
	public void draw(Graphics2D g2) {
		...
		g2.drawImage(image, worldX, worldY, BMGamePanel.tileSize, BMGamePanel.tileSize, null);
	}
