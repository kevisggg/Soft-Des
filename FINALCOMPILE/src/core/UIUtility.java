...
public class UIUtility {
	...
	public static final String gameFontPath = "/BM/font/Pixeboy-z8XGD.ttf";
	public Font defGameFont;
	private Stroke defaultStroke;
	public UIUtility() {
		try {
			defGameFont = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream(gameFontPath));
        } catch (Exception e) {
        	defGameFont = new Font("Arial", Font.BOLD, 24);
        }
	}
	...
	public Font createFont(int size) {
		return defGameFont.deriveFont(Font.BOLD, size);
	}
