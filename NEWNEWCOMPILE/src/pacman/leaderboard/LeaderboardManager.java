...
public class LeaderboardManager implements Serializable {
    ...
    private void save() {
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("PMleaderboard.dat"))) {
    ...
    public ArrayList<PlayerScore> load() {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("PMleaderboard.dat"))) {
