...
public class MainMenuPanel extends AbstractGamePanel implements Runnable{
	...
	private int i;
	public static final int MENU_WIDTH = 768;
	...
	public void setMainLeaderState() {gamestateH.setState(new MainLeaderboardState(ui));}
