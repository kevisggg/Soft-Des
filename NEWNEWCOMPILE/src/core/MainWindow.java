...
public class MainWindow extends JFrame {
    ...
    public void startSpaceInvaders() {
        ...
        repaint();
        gp.requestFocusInWindow();
        System.out.println("SmG STARTED");
    }
    ...
    public void startPacman() {
        ...
        Game game = new Game(this); // Game with all states
        Pacman pacmanGame = game.getPlayState().getPacman(); // extract Pacman
		this.setFocusable(true);
        setTitle("PacMan");
        setContentPane(pacmanGame);
        pack();
