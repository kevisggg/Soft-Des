...
import bomberman.main.state.BMInsState;
import bomberman.main.state.BMPauseState;
import bomberman.main.state.BMPlayState;
import bomberman.main.state.BMWinState;
...
public class BMGamePanel extends AbstractGamePanel implements Runnable{
	...
	public void newLevel() {
		...
		enemies.clear();
	    obj.clear();
		tileMgr.loadMap("/BM/maps/mapblank.txt"); 
		asset.setEnemy();
		asset.resetObjCnt();
		keyH.resetKeys();
		setPlayState();
