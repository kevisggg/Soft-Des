...
public class StartMenu
{
  ...
  public StartMenu()
  {
    try
    {
      bg = new Background("/SI/backgrounds/titlescreenbackground.png", -0.4, 0);
      spaceInvadersTitle = ImageIO.read(getClass().getResourceAsStream("/SI/backgrounds/titlescreen.png"));
    }
    catch(Exception e)
    {
      e.printStackTrace();
